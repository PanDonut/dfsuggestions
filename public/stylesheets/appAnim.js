...
for(let i=0; i< card.length; i++){
    ...
    card[i].addEventListener('click',()=>{
        ...
        movieType.innerHTML ="<span id='topic'>Typ:</span> &nbsp;" + data[i]['Type'];
        movieLang.innerHTML = "<span id='topic'>Język:</span> &nbsp;" + data[i]['Language'];
        movieGenre.innerHTML = "<span id='topic'>Gatunek:</span> &nbsp;" + data[i]['Genre'];
        moviePlot.innerHTML = data[i]['Plot'];
        movieRelease.innerHTML = "<span id='topic'>Data wydania:</span> &nbsp;" + data[i]['Released'];
        movieDirector.innerHTML = "<span id='topic'>Reżyser:</span> &nbsp;" + data[i]['Director'];
        movieCast.innerHTML = "<span id='topic'>Obsada:</span> &nbsp;" + data[i]['Actors'];
        // -------------------------------------------------
